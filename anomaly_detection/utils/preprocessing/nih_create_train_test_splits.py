...
# python anomaly_detection/utils/preprocessing/nih_create_train_test_splits.py --output_root /data1/LJL/MICCAI/data/COVID_xray/data/data/nih/
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path_to_data_entry",
                        type=str,
                        default='/data1/LJL/MICCAI/data/COVID_xray/nih/Data_Entry_2017.csv',
                        help='path_to_data_entry')
    parser.add_argument("--path_to_train_val_list",
                        type=str,
                        default='/data1/LJL/MICCAI/data/COVID_xray/nih/train_val_list_2.txt',
                        help='path_to_train_val_list')
    parser.add_argument("--path_to_test_list",
                        type=str,
                        default='/data1/LJL/MICCAI/data/COVID_xray/nih/test_list_2.txt',
